    ...
    $.fn.zoom = function (options) {
        ...
        if ($ul.is("ul") && $ul.children("li").length && $ul.find(".bzoom_big_image").length) {
            ...
            if (!$(".bzoom_magnifier").length) {
                $bzoom_magnifier = $('<li class="bzoom_magnifier"><div class="bzoom_magnifier_container"><a data-fancybox="gallery" href="https://unsplash.it/375/500?image=201"><img src="" /></a></div></li>');
