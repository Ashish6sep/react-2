...
import { AJAX_REQUEST, CURRENCY_FORMAT, GET_STORAGE, CUSTOMER_URL } from "../../Constants/AppConstants";
                                                                                        ...
                                                                                        <tfoot>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <br /><small className="shipped_via"> {order.hasOwnProperty("shipping") ? order.shipping : null} </small>
                                                                                                </td>
                                                                                            </tr>
                                                                                            {
                                                                                                                    ...
                                                                                                                    return (
                                                                                                                        <Fragment key={key}>
                                                                                                                            <tr className="order">
                                                                                                                                ...
                                                                                                                                <td data-title="">
                                                                                                                                    <a className="wc-forward" href={`${CUSTOMER_URL}my-account/related-subscription/${subscription.subscription_id}`}>View</a>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </Fragment>
                                                                                                                    )
