...
class BundleProduct extends PureComponent {
    constructor(props) {
        super(props);
        this.state = { 
            loading: true,
         ...
         document.title = "Bundle Product -Prestige Labs";
    }
    ...
    getProducts = (filterBy) => {
        const data = { filter_by: filterBy, type: 'bundle' }
                                        ...
                                        <main className="athletes_list_wrapper">    
                                            <nav aria-label="breadcrumb">
                                                <ol className="breadcrumb cus_breadcrumb">
                                                    ...
                                                    <li className="breadcrumb-item active" aria-current="page">Bundle Product</li>
                                                </ol>
                                            </nav>

                                            <h3 className="montserrat page-title">Bundle Product</h3>
