...
import { GET_STORAGE, USER, CUSTOMER_URL, AJAX_PUBLIC_REQUEST, DISTRIBUTOR_URL, AJAX_REQUEST,BASE_URL } from "../../Constants/AppConstants";
...
class Header extends PureComponent {
    ...
    componentDidMount() {
        ...
        if(BASE_URL=="https://dev.protibimbo.com/")
        {
        const enteredName=prompt('This is a development environment for Prestige Labs. \nPlease enter the authorization code to get access.')
        if(enteredName!="pldev@2020")
        {
            window.location.href="http://prestigelabs.com/"
        }
    }
        const CEScript = document.createElement("script");
    
        CEScript.src = "//script.crazyegg.com/pages/scripts/0096/5404.js";
        CEScript.async = true;
        CEScript.charset="UTF-8";
                                ...
                                <ul className="mob_site_content">
                                            ...
                                            if (menu.type === "external") {
                                                if (menu.manual_position != 'last') {
                                                    return (
                                                        <li key={"ddm" + key}>
                                                            <a
                                                                target={menu.open_new_tab == "yes" ? "_blank" : "_self"} className={`menu_item${
...

                                    {
                                        enable_new_signup && !this.props.auth.isAuthenticated ?
                                            <li key={Math.random()}>
                                                <a className="menu_item" href={DISTRIBUTOR_URL + 'login'}><span>BECOME AN AFFILIATE</span></a>
                                            </li>
                                            : ''
                                    }
